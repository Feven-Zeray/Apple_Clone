...
//product.product_id
// err kale handle miyaregbet miseten data row nw mibal mimetawn data products key askemetat keza be obj wrap aregat jspon wst asgebat mtsetegnin response json wst asgebat keza product mibal key be obj melk ysetewal rowsn ke db yametaletal. products yafelege mimetaw data be array nw gn be obj wrap tedergo nw be dot access lemareg